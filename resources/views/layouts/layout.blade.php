...
<!-- Mirrored from themesbrand.com/velzon/html/default/dashboard-job.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 May 2023 08:16:48 GMT -->
                ...
                <div class="navbar-header">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="#popup"> Session</li></a>
            ...
            -->
                    <div id="popup" class="overlay">
                        <div class="card popup">
                            <h4 class="text-center"> <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                                <br> Changer de Session
                            </h4>
                            <a class="close" href="#">&times;</a>
                            <div class="content">
                                <form action="" class=' w-70'>
                                    <label for=""></label>
                                    <select class="form-select m-2 w-75" name="" id="">
                                        <option value="2023-2024">2023-2024</option>
                                        <option value="2022-2023">2022-2023</option>
                                        <option value="2021-2022">2021-2022</option>
                                    </select>
                                    <hr>
                                    <button type="submit" id="btnFetch" class="btn btn-success btn-block">
                                        Enregister<i class="fa fa-check" aria-hidden="true"
                                            onclick="myFunction(event)"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
                                ...
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Anna
                                            Adame</span>
                                        <span
                                            class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Secretaire
                                            general IDP</span>
                                    </span>
                                </span>
                            </button>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="menu-title"><i class="ri-more-fill"></i> <span data-key="t-components">Gestion
                                Academique</span></li> <!-- end Dashboard Menu -->
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route("etudiant.index") }}">
                                <i class=" ri-account-box-fill"></i> <span>Etudiants</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route("personnels.enseignants.index") }}">
                                <i class=" ri-contacts-book-line"></i> <span>Enseignant</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route("options.index") }}">
                                <i class="ri-tools-fill"></i> <span>Options</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="layout.html">
                                <i class=" ri-calendar-todo-fill"></i> <span>Planning des Examens
                                </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route("register-notes.index") }}">
                                <i class="ri-file-text-line"></i> <span>Registre des Notes
                                </span>
                            </a>
                        </li>
                        <li class="menu-title"><i class="ri-medal-fill"></i> <span
                                data-key="t-components">Certificats</span></li>
                        <li class="nav-item">
                            <a class="nav-link " href="#sidebarDashboards">
                                <i class="ri-account-box-fill"></i> <span data-key="t-dashboards">Carte
                                    d'Etudiant</span>
                            </a>
                        </li>
                    </ul>
